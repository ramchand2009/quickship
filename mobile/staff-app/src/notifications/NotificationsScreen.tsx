...
const styles = StyleSheet.create({
  ...
  settingsButton: { minHeight: 42, borderColor: '#B8D5C8', borderWidth: 1, borderRadius: 13, paddingHorizontal: 11, backgroundColor: '#FFFFFF', flexDirection: 'row', alignItems: 'center', columnGap: 6 },
  settingsText: { color: '#0B5D3B', fontSize: 12, fontWeight: '800' },
  preferencesCard: { backgroundColor: '#FFFFFF', borderColor: '#DEE7E3', borderWidth: 1, borderRadius: 18, paddingHorizontal: 15, marginBottom: 16, shadowColor: '#17352A', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 6, elevation: 1 },
  ...
  notificationCard: { backgroundColor: '#FFFFFF', borderColor: '#DEE7E3', borderWidth: 1, borderRadius: 17, padding: 14, marginBottom: 10, flexDirection: 'row', alignItems: 'center', shadowColor: '#17352A', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.04, shadowRadius: 5, elevation: 1 },
