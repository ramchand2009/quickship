...
const styles = StyleSheet.create({
  ...
  actionList: { rowGap: 9 },
  actionButton: { minHeight: 50, borderColor: '#B8D5C8', borderWidth: 1, borderRadius: 13, backgroundColor: '#F4FAF7', paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', columnGap: 10 },
