...
MOBILE_API_ENABLED = _env_bool("MOBILE_API_ENABLED", DEBUG)
MOBILE_AUTH_ENABLED = _env_bool("MOBILE_AUTH_ENABLED", DEBUG)
MOBILE_READ_API_ENABLED = _env_bool("MOBILE_READ_API_ENABLED", DEBUG)
MOBILE_WRITE_API_ENABLED = _env_bool("MOBILE_WRITE_API_ENABLED", DEBUG)
MOBILE_PUSH_ENABLED = _env_bool("MOBILE_PUSH_ENABLED", False)
EXPO_PUSH_API_URL = os.environ.get(
    "EXPO_PUSH_API_URL",
    "https://exp.host/--/api/v2/push/send",
).strip()
EXPO_PUSH_ACCESS_TOKEN = os.environ.get("EXPO_PUSH_ACCESS_TOKEN", "").strip()
MOBILE_DASHBOARD_CACHE_SECONDS = max(
    1, int(os.environ.get("MOBILE_DASHBOARD_CACHE_SECONDS", "30") or 30)
)
MOBILE_SESSION_ABSOLUTE_LIFETIME_DAYS = int(
    os.environ.get("MOBILE_SESSION_ABSOLUTE_LIFETIME_DAYS", "30") or 30
)
...
MOBILE_ACCESS_TOKEN_CLOCK_SKEW_SECONDS = int(
    os.environ.get("MOBILE_ACCESS_TOKEN_CLOCK_SKEW_SECONDS", "30") or 30
)
MOBILE_ACCESS_TOKEN_ISSUER = os.environ.get("MOBILE_ACCESS_TOKEN_ISSUER", "mathukai-api").strip()
MOBILE_ACCESS_TOKEN_AUDIENCE = os.environ.get(
    "MOBILE_ACCESS_TOKEN_AUDIENCE", "mathukai-operations-android"
).strip()
MOBILE_JWT_SIGNING_KEY_EXPLICIT = bool(os.environ.get("MOBILE_JWT_SIGNING_KEY", "").strip())
MOBILE_JWT_SIGNING_KEY = os.environ.get("MOBILE_JWT_SIGNING_KEY", "").strip() or SECRET_KEY
MOBILE_REFRESH_TOKEN_HASH_KEY = (
    os.environ.get("MOBILE_REFRESH_TOKEN_HASH_KEY", "").strip() or MOBILE_JWT_SIGNING_KEY
)
LOGIN_TRUSTED_PROXY_COUNT = max(0, int(os.environ.get("LOGIN_TRUSTED_PROXY_COUNT", "0") or 0))
...
REST_FRAMEWORK = {
    'NUM_PROXIES': LOGIN_TRUSTED_PROXY_COUNT,
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'core.api.v1.authentication.MobileAccessTokenAuthentication',
    ],
